...
Connection conn;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 260, 470, 260));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 540, 200, 48));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 26, -1, 160));
        ...
        jButton5.setForeground(new java.awt.Color(25, 13, 248));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 190, 80, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon("/home/prateek/NetBeansProjects/Employee_Management_System/proje.jpg")); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1160, 640));
...
/*
    ...
    public void Update() {
        ...
        try{   
        String sql="select Dept_id,Department,Manager_id from Department";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
