...
/**
 * Bean info for the {@link JBarChart} bean.
 */
public class JBarChartBeanInfo extends SimpleBeanInfo {
    ...
    public BeanInfo[] getAdditionalBeanInfo() {
        return new BeanInfo[] {new AbstractCategoryChartBeanInfo(), 
                new AbstractChartBeanInfo()};    
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        final String prefix = "JBarChart.";
        
        // these regular properties are defined...
        Object[][] props = new Object[][] { 
            {"dataset", Boolean.FALSE, "Category.Dataset"},
            {"barOutlineVisible", Boolean.FALSE, "Category.BarRenderer"},
            {"barItemMargin", Boolean.TRUE, "Category.BarRenderer"},
            {"barBaseValue", Boolean.TRUE, "Category.BarRenderer"}
        };
