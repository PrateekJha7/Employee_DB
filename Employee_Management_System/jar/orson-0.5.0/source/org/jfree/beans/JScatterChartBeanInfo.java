...
/**
 * Bean info for the {@link JScatterChart} bean.
 */
public class JScatterChartBeanInfo extends SimpleBeanInfo {
    ...
    public BeanInfo[] getAdditionalBeanInfo() {
        return new BeanInfo[] {new AbstractChartBeanInfo(), 
                new AbstractXYChartBeanInfo(), new NumericalXYChartBeanInfo()};    
    }
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        final String prefix = "JScatterChart.";
