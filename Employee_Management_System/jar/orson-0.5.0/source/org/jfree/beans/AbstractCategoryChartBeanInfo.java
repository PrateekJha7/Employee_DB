...
/**
 * A description of the {@link AbstractCategoryChart} class.
 */
public class AbstractCategoryChartBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        final String prefix = "AbstractCategoryChart.";
        
        // these regular properties are defined...
        Object[][] props = new Object[][] { 
            {"orientation", Boolean.FALSE, "Category.Plot"},
            {"categoryAxisLocation", Boolean.FALSE, "Category.CategoryAxis"},
            {"categoryAxisLabel", Boolean.FALSE, "Category.CategoryAxis"},
            {"categoryAxisLabelFont", Boolean.FALSE, "Category.CategoryAxis"},
            {"categoryAxisLabelPaint", Boolean.FALSE, "Category.CategoryAxis"},
            {"categoryAxisLineVisible", Boolean.FALSE, "Category.CategoryAxis"},
            {"categoryAxisMargin", Boolean.TRUE, "Category.CategoryAxis"},
            {"categoryAxisLowerMargin", Boolean.FALSE, "Category.CategoryAxis"},
            {"categoryAxisUpperMargin", Boolean.FALSE, "Category.CategoryAxis"},
            {"valueAxisLocation", Boolean.FALSE, "Category.ValueAxis"},
            {"valueAxisLabel", Boolean.FALSE, "Category.ValueAxis"},
            {"valueAxisLowerMargin", Boolean.FALSE, "Category.ValueAxis"},
            {"valueAxisUpperMargin", Boolean.FALSE, "Category.ValueAxis"},
            {"valueAxisLineVisible", Boolean.FALSE, "Category.ValueAxis"},
            {"valueAxisInverted", Boolean.FALSE, "Category.ValueAxis"},
            {"valueAxisGridlinesVisible", Boolean.FALSE, "Category.ValueAxis"},
    ...
    public EventSetDescriptor[] getEventSetDescriptors() {
        ...
        try {
            e1 = new EventSetDescriptor(AbstractCategoryChart.class, 
                    "categoryItemClick", CategoryItemClickListener.class, 
                    "onCategoryItemClick");
